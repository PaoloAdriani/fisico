...
viewSize  = parameters.viewSize ?: defaultViewSize
viewIndex = parameters.viewIndex ?: 0
...
def lowIndex  = catResult.lowIndex
def highIndex = catResult.highIndex
def listSize  = catResult.listSize
