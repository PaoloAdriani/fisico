...
//@mpstyle VAT Number
partyIdentNumberVat = from("PartyIdentification").where("partyId", partyId, "partyIdentificationTypeId", "VAT_ID").queryOne()

if (partyIdentNumberVat) {
    context.vatNumber = partyIdentNumberVat.getString("idValue")
}
