    ...
    <!-- Page Title
         ...
         <section id="slider" class="slider-element mt-3">
         	<div class="masonry-thumbs grid-container row row-cols-6" data-big="3" data-lightbox="gallery">
         	    <#list 1..33 as i>
                    <a class="grid-item" href="<@ofbizContentUrl>/fi_it/assets/images/campaign/adv2020/miami20_${i}.jpg</@ofbizContentUrl>" data-lightbox="gallery-item">
                        <div class="grid-inner">
                            <img src="<@ofbizContentUrl>/fi_it/assets/images/campaign/adv2020/miami20_${i}.jpg</@ofbizContentUrl>" alt="Gallery Thumb 1">
