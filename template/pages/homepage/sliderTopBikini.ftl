                ...
                <div class="swiper-slide dark">
                    ...
                    <div class="container">
                        <div class="slider-caption">
                            <h2 data-animate="fadeInUp">${SystemLabelMap.TopBikini}</h2>
                        </div>
                    </div>
                   <div class="swiper-slide-bg" style="background-image: url('<@ofbizContentUrl>/fi_it/assets/images/homepage/top_bikini_18022026.jpg</@ofbizContentUrl>');"></div>
                </div>
            </div>
        </div>
    </div>
