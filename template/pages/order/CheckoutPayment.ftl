...
<div class="row justify-content-end align-items-center py-2 col-mb-30 col-md-offset-4">
  <div class="col-auto mr-auto">
    <a href="javascript:submitForm(document.getElementById('checkoutInfoForm'), 'CS', '');" class="button button-small button-3d button-black m-0">${uiLabelMap.OrderBacktoShoppingCart}</a>
  </div>
  <div class="col-auto">
    <a href="javascript:submitForm(document.getElementById('checkoutInfoForm'), 'DN', '');" class="button button-small button-3d button-black m-0">${uiLabelMap.OrderContinueToFinalOrderReview}</a>
  </div>
</div>
</div>
</div>
