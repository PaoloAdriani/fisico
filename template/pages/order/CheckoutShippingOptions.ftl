            ...
            <div class="card mb-0">
                ...
                <div class="row justify-content-end align-items-center py-2 col-mb-30 col-md-offset-4">
                  <div class="col-auto mr-auto">
                      <a href="#"
                          class="button button-small button-3d button-black m-0 upper js-submit" data-url="<@ofbizUrl>updateCheckoutOptions/showCart</@ofbizUrl>">${SystemLabelMap.OrderBacktoShoppingCart}</a>
                  </div>
                  <div class="col-auto">
                      <a href="#"
                          class="button button-small button-3d button-black m-0 upper js-submit" data-url="<@ofbizUrl>checkoutOptions</@ofbizUrl>">${SystemLabelMap.CommonNext}</a>
                  </div>
                </div>
            </div>
        </div>
