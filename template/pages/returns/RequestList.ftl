            ...
            <div class="card mb-0 upper">
                ...
                <div class="col-12 col-sm-12 col-lg-12 card-body" >
                    <table class="table table-responsive">
                        ...
                        <tr>
                            <th>
                               ${SystemLabelMap.OrderRequest} ${SystemLabelMap.CommonNbr}
                            </th>
                            <th>
                               ${SystemLabelMap.CommonType}
                            </th>
                            <th>
                               ${SystemLabelMap.CommonName}
                            </th>
                            <th>
                               ${SystemLabelMap.CommonDescription}
                            </th>
                            <th>
                              ${SystemLabelMap.CommonStatus}
                            </th>
                            <th>
                              ${SystemLabelMap.OrderRequestDate}
                            </th>
                            <th>
                              ${SystemLabelMap.OrderRequestCreatedDate}
                            </th>
                            <th>
                              ${SystemLabelMap.OrderRequestLastModifiedDate}
                            </th>
                            <th colspan="2"></th>
                        </tr>
                        </thead>
                        ...
                        <#if !requestList?has_content>
                            <div class="alert alert-light" role="alert">
                                ${SystemLabelMap.OrderNoRequestFound}
                            </div>
                        </#if>
                    </table>
                </div>
